 ...
 */
public record CelestialBodyLevelData(Holder<CelestialObject> celestialObject, float temperatureModifier, AtmosphereInfo atmosphereInfo, float gravityScale, CelestialBodyTransition transition) {
