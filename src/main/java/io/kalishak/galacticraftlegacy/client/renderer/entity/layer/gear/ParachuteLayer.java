...
public class ParachuteLayer<S extends LivingEntityRenderState, M extends EntityModel<S>> extends GearEquipmentLayer<S, M> implements ParachuteRenderable<S> {
    ...
    public ParachuteLayer(RenderLayerParent<S, M> renderer, MaterialSet materials, EntityModelSet entityModelSet, EquipmentLayerRenderer layerRenderer, EquipmentAssetManager equipmentAssetManager) {
