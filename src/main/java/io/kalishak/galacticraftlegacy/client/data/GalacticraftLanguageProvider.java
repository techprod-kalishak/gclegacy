...
public class GalacticraftLanguageProvider extends ExtendedLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(GalacticraftComponents.DATAPACK_DESCRIPTION.toString(), "Galacticraft Legacy data pack");
        add(GalacticraftComponents.CLASSIC_ASSETS_DESCRIPTION.toString(), "Galacticraft 4 Developer's Art");
        add(GalacticraftComponents.ADVENTURE_MODE_DESCRIPTION.toString(), "Adventure mode features");
        ...
        add(GalacticraftComponents.INFINITE.toString(), "Infinite");
        add(GalacticraftComponents.CREATIVE_ONLY.toString(), "Creative Only");
        ...
        add(GalacticraftComponents.FILTER_NAME_HEATABLE.toString(), "Showing Heatable");
        add(GalacticraftComponents.FILTER_NAME_ARC_HEATABLE.toString(), "Showing Arc Heatable");
        ...
        add("galacticraftlegacy.argument.schematic.invalid", "Unregistered Schematic: %s!");
        ...
        addBlock(GalacticraftBlocks.MOON_ROCK_SLAB, "Moon Rock Slab");
        addBlock(GalacticraftBlocks.MOON_ROCK_STAIRS, "Moon Rock Stairs");
        addBlock(GalacticraftBlocks.MOON_ROCK_WALL, "Moon Rock Wall");
        ...
        addBlock(GalacticraftBlocks.MOON_CHEESE_ORE, "Moon Cheese Ore");
        ...
        addBlock(GalacticraftBlocks.RAW_METEORIC_IRON_BLOCK, "Raw Meteoric Iron Block");
        addBlock(GalacticraftBlocks.METEORIC_IRON_BLOCK, "Solid Meteoric Iron Block");
        ...
        addBlock(GalacticraftBlocks.TIN_WALL_DECORATION_BLOCK, "Tin Wall Decoration Block");
        addBlock(GalacticraftBlocks.TIN_WALL_DECORATION_SLAB, "Tin Wall Decoration Block Slab");
        addBlock(GalacticraftBlocks.TIN_WALL_DECORATION_STAIRS, "Tin Wall Decoration Block Stairs");
        addBlock(GalacticraftBlocks.SPACE_STATION, "Space Station Holder");
        addBlock(GalacticraftBlocks.MARS_REGOLITH, "Mars Regolith");
        addBlock(GalacticraftBlocks.MARS_FINE_REGOLITH, "Mars Fine Regolith");
        addBlock(GalacticraftBlocks.MARS_STONE, "Mars Stone");
        ...
        addBlock(GalacticraftBlocks.MARS_COBBLESTONE_WALL, "Mars Cobblestone Wall");
        addBlock(GalacticraftBlocks.MARS_BRICKS, "Mars Dungeon Bricks");
        addBlock(GalacticraftBlocks.MARS_BRICK_SLAB, "Mars Dungeon Brick Slab");
        addBlock(GalacticraftBlocks.MARS_BRICK_STAIRS, "Mars Dungeon Brick Stairs");
        addBlock(GalacticraftBlocks.MARS_BRICK_WALL, "Mars Dungeon Brick Wall");
        addBlock(GalacticraftBlocks.MARS_COPPER_ORE, "Mars Copper Ore");
