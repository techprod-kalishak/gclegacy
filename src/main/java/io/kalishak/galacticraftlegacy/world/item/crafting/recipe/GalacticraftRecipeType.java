...
public final class GalacticraftRecipeType {
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<VehicleCraftingRecipe>> VEHICLE_CRAFTING = REGISTRY.register(
            "vehicle_crafting",
            () -> RecipeType.simple(Constants.id("vehicle_crafting"))
    );
