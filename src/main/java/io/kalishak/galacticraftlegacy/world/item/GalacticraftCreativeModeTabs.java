...
public final class GalacticraftCreativeModeTabs {
    ...
    private static void buildItems(CreativeModeTab.ItemDisplayParameters itemDisplayParameters, CreativeModeTab.Output output) {
        ...
        output.accept(GalacticraftItems.CANVAS);
        ...
        output.accept(GalacticraftItems.SINGLE_SOLAR_MODULE);
        output.accept(GalacticraftItems.FULL_SOLAR_PANEL);
        ...
        output.accept(GalacticraftItems.THERMAL_CONTROLLER);
