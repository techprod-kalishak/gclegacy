...
public class FlagItem extends Item {
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand) {
        ...
        if (hitresult.getType() == HitResult.Type.BLOCK) {
            ...
            Flag flag = new Flag(level, SpaceRaceManager.getPlayerFlag(level, player), clickedPosition.x, clickedPosition.y, clickedPosition.z, (float) player.getY());
    ...
    public void onCraftedBy(ItemStack stack, Player player) {
        ...
        SpaceRaceTeam team = player.level()
                .getData(GalacticraftAttachments.SPACE_RACE_MANAGER)
                .getSpaceRaceTeamById(player.getUUID());
        ...
        if (team != null) {
            ...
            stack.set(
                    ...
                    new FlagItemData(
                            player.getData(GalacticraftAttachments.PLAYER_SPACE_DATA).getPrivateFlagData(),
                            Component.empty()
                    )
            );
        }
