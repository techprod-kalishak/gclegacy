...
public class GalacticraftFoods {
    ...
    public static final CannedFood DEHYDRATED_APPLE = CannedFood.builder()
            .name(Component.translatable("item.galacticraftlegacy.dehydrated_apple").withStyle(ChatFormatting.YELLOW))
    ...
    public static final CannedFood DEHYDRATED_CARROT = CannedFood.builder()
            .name(Component.translatable("item.galacticraftlegacy.dehydrated_carrot").withStyle(ChatFormatting.YELLOW))
    ...
    public static final CannedFood DEHYDRATED_MELON = CannedFood.builder()
            .name(Component.translatable("item.galacticraftlegacy.dehydrated_melon").withStyle(ChatFormatting.YELLOW))
    ...
    public static final CannedFood DEHYDRATED_PUMPKIN = CannedFood.builder()
            .name(Component.translatable("item.galacticraftlegacy.dehydrated_pumpkin").withStyle(ChatFormatting.YELLOW))
            .food(builder -> builder.nutrition(4).saturationModifier(0.4F))
    ...
    public static final CannedFood DEHYDRATED_POTATO = CannedFood.builder()
            .name(Component.translatable("item.galacticraftlegacy.dehydrated_potato").withStyle(ChatFormatting.YELLOW))
            .food(builder -> builder.nutrition(2).saturationModifier(0.3F))
            .build();
    public static final CannedFood CANNED_BEEF = CannedFood.builder()
            .name(Component.translatable("item.galacticraftlegacy.canned_beef").withStyle(ChatFormatting.YELLOW))
            .food(builder -> builder.nutrition(8).saturationModifier(0.6F))
            .build();
}
