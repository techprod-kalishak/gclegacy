...
public final class GearEquipmentAssets {
    ...
    public static final ColorCollection<ResourceKey<EquipmentAsset>> PARACHUTES = ColorCollection.prefixWithColor(ColorCollection.create("parachute")).map(id -> key(EquipmentAssets.ROOT_ID, id));
}
