...
public record VehicleCraftingDataRecipe(NonNullList<VehicleCraftingEntry> inputSlots, VehicleCraftingEntry outputSlot) {
    ...
    public static final Codec<ResourceKey<VehicleCraftingDataRecipe>> KEY_CODEC = ResourceKey.codec(GalacticraftRegistries.Keys.VEHICLE_CRAFTING_RECIPE_DATA);
    ...
    public static class Builder {
        ...
        public Builder inputSlot(ResourceKey<VehicleCraftingSlotType> slotType, int xOffset, int yOffset) {
        ...
        public Builder outputSlot(int xOffset, int yOffset) {
