                ...
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(GalacticraftItems.FLUID_TANK).setWeight(5).apply(SetItemFluidTankFunction.setFluid(GalacticraftFluids.OIL, ConstantInt.of(1000))))
